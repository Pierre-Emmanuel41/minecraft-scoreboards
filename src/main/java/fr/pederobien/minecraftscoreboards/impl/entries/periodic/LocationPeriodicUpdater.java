...
public class LocationPeriodicUpdater extends PeriodicUpdater<LocationEntry> {
	 ...
	 * @see LocationEntry
	 */
	public LocationPeriodicUpdater(Plugin plugin, ISimpleObjective objective, long delay, long period, int score) {
		this(plugin, objective, delay, period, new LocationEntry(score));
	}
	 ...
	 * @see LocationEntry
	 */
	public LocationPeriodicUpdater(Plugin plugin, ISimpleObjective objective, long period, int score) {
		this(plugin, objective, period, new LocationEntry(score));
	}
}
